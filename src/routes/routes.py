...
import json
from utils.tool_utils import get_current_time, handle_cancellation
from utils.schemas import time_tool_schema, handle_cancellation_schema
import logging
...
agent.register_tool(handle_cancellation_schema, handle_cancellation)
#agent.register_tool()
